...
static func create(main_tag: StringName, sub_tag: StringName, coord: Vector2i,
        offset: Vector2i, palette: Dictionary) -> Sprite2D:
...
static func create_ground(sub_tag: StringName, coord: Vector2i,
        palette: Dictionary) -> Sprite2D:
    return create(MainTag.GROUND, sub_tag, coord, Vector2i(0, 0), palette)


static func create_actor(sub_tag: StringName, coord: Vector2i,
        palette: Dictionary) -> Sprite2D:
    return create(MainTag.ACTOR, sub_tag, coord, Vector2i(0, 0), palette)
